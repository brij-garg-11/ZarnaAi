...
# Deferred to avoid import issues during module load
...
def _render_impact_section(impact: dict, era: str = "post") -> str:
    from app.admin.insights import _render_impact_section as _impl
    return _impl(impact, era)


def _render_learning_tab(stats: dict) -> str:
    from app.admin.insights import _render_learning_tab as _impl
    return _impl(stats)


def _render_insights_tab(stats: dict, insights_days: int = 30, insights_era: str = "post") -> str:
    from app.admin.insights import _render_insights_tab as _impl
    return _impl(stats, insights_days, insights_era)
...
def _render_podcast_tab() -> str:
    from app.admin.podcast import render_podcast_tab
